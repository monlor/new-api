...
func InitOptionMap() {
	...
	common.OptionMap["PaymentCurrency"] = operation_setting.PaymentCurrency
	...
	common.OptionMap["QuotaForInviterThreshold"] = strconv.Itoa(common.QuotaForInviterThreshold)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "PaymentCurrency":
		operation_setting.PaymentCurrency = value
	...
	case "QuotaForInviterThreshold":
		common.QuotaForInviterThreshold, _ = strconv.Atoi(value)
