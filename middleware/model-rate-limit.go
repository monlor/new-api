...
func redisRateLimitHandler(duration int64, totalMaxCount, successMaxCount int) gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if !allowed {
			...
			model.RecordRejectionLog(c, model.SystemLogTypeRateLimit, "rate_limit_success_exceeded", msg, http.StatusTooManyRequests)
			return
		}
		...
		if totalMaxCount > 0 {
			...
			if !allowed {
				...
				abortWithOpenAiMessage(c, http.StatusTooManyRequests, msg)
				model.RecordRejectionLog(c, model.SystemLogTypeRateLimit, "rate_limit_total_exceeded", msg, http.StatusTooManyRequests)
			}
		}
